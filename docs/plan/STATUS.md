...
| C02 | IN_PROGRESS | sdk agent | A02,B03,B05 | ADR-0007 amends allowed paths to add `packages/crypto-wasm/` for client-side OPAQUE exports (mechanical, no new cryptography); dispatched to a worktree agent 2026-09-04. |
