...
| SD-0003 | Envelope/v1 bytes, key hierarchy, KDF/AEAD parameters, and recovery authorization await approval | ADR-0003 / pending H01 | Pending | crypto-envelope/v1 and A04 vectors | A04,H01,B01,B03,B04 |
...
| SD-0005 | Metadata leakage is minimized, not zero; budget and retention require approval | ADR-0004 / open | Pending | T11 verification and metadata inventory | A01,A02,B02,B05,Q01,R01 |
