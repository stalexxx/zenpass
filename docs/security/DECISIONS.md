...
| SD-0003 | Envelope/v1 bytes, key hierarchy, KDF/AEAD parameters, recovery authorization, and selected crypto libraries are frozen with deferred findings | ADR-0003 / approved with findings (2026-09-03) | stalexxx, Human security reviewer | ADR-0003 approval record; H01 checklist; F-2/F-3 impose B01/A04 verification and retain H02 external-audit gate | A04,H01,B01,B03,B04 |
