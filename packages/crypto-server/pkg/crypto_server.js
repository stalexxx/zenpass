/* @ts-self-types="./crypto_server.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function generate_server_setup() {
    const ret = wasm.generate_server_setup();
 ...
 * @param {Uint8Array} state
 * @param {Uint8Array} ke3
 * @param {Uint8Array} context
 */
export function login_finish(state, ke3, context) {
    const ptr0 = passArray8ToWasm0(state, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(ke3, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(context, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.login_finish(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[1]) {
 ...
 * @param {string} credential_identifier
 * @param {Uint8Array} ke1
 * @param {Uint8Array} context
 * @returns {any}
 */
export function login_start(setup, password_file, credential_identifier, ke1, context) {
    const ptr0 = passArray8ToWasm0(setup, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(password_file, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(credential_identifier, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(ke1, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passArray8ToWasm0(context, wasm.__wbindgen_malloc);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.login_start(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {Uint8Array} setup
 * @param {string} credential_identifier
 * @param {Uint8Array} client_message
 * @returns {any}
 */
export function registration_step(setup, credential_identifier, client_message) {
    const ptr0 = passArray8ToWasm0(setup, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(credential_identifier, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(client_message, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.registration_step(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('crypto_server_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
